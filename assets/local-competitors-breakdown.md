# Local Competitor Breakdowns — the other Dripping Springs schools
### Companion to `stoic-breakdown.md`
...
**261 Frog Pond Ln** (Joao is at 120) · [gbdrip.com](https://www.gbdrip.com/) · 512-971-9359 · IG [@gbdrippingspringstx](https://www.instagram.com/gbdrippingspringstx/)

- **Offer `[OBSERVED]`:** **Free trial class** (60 min), scheduled by emailing contact@gbdrip.com; they provide a loaner uniform. No standing "/offer" funnel page like Stoic — it's email/contact-form driven.
- **Kids program `[OBSERVED]`:** GBK, split by age — **Tiny Champs (4–6), Little Champs (7–9), Juniors (10–12), Teens (13–15).** Plus a **Homeschool class (ages 6–12)** midday.
- **Adults `[OBSERVED]`:** three tiers — **GB1 Beginner / GB2 Advanced / GB3 Expert** — Gi + NoGi, All Levels, Open Mat. Sparring opens at 3 stripes on white (~5–6 months).
- **Membership terms `[OBSERVED]` (notably transparent):** unlimited, flexible, **month-to-month, NO contracts, NO cancellation fees**, auto-billed the 1st, 30 days notice to cancel, **pausable up to 2 months**, first month prorated, tournament coaching included. *(They publish their terms clearly — but NOT prices.)*
- **Pricing `[OBSERVED gap]`:** not published anywhere on the site.
- **Instructors `[OBSERVED]`:** founded **May 2021** by **Alexandre "Dande" Santos (4th-degree black belt)** + **Robert "Max" Bookman (black belt).**
- **Tech `[OBSERVED]` / `[INFERRED]`:** standard Gracie Barra brand-template site + **"GB Online"** (members' video library). `[INFERRED]` likely a franchise marketing template; no funnel page observed.
- **Positioning `[OBSERVED]`:** "Jiu-Jitsu For Everyone," the global **Gracie Barra brand**, "bully-proof" kids, and an explicit **ADHD / behavior / learning-difficulties** angle; competition optional. Their FB claims a "Most Trusted" award for the GB1 beginner program `[OBSERVED — their claim, not independently verified]`.
- **Schedule `[OBSERVED]`:** Mon–Fri 6:30am–9:00pm, Sat 10:00am–1:00pm.

**What we take / how Joao counters:**
- 🔴 **Biggest threat:** the **Gracie Barra brand** + a **clean, no-contract membership model** + structured global curriculum + GB Online. That's a strong, trustworthy package, and they're on his street.
- ⚠️ **Direct overlap:** GB markets the **ADHD/behavior/bully-proof** angle — close to Joao's emotional-regulation message. Joao should **out-specialize** here: his is a real *method* (Montessori-informed, 25 yrs, *Grapple with Emotions* book), not a franchise add-on.
- ✅ **Joao's durable edges vs GB:** **age 3** (GB starts at 4), his **specific lineage + author/podcast/longevity** (since 2003 vs GB's 2021), and **4.8★/98 reviews**. GB counters with brand, not coach.
- 💡 **Copyable:** GB's **transparent, no-contract, pausable membership terms** are reassuring to parents — worth matching/beating on clarity (we can be transparent on *terms* without publishing price).
...
## 4. Updated local picture (verified intro offers)
| School | Intro offer | Kids start age | Pricing public? | Notable |
|---|---|---|---|---|
