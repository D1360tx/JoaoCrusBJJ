...
- The published Google tag must explicitly map `page_location` and `page_referrer` from the sanitized data-layer values. Top-level data-layer keys are not forwarded automatically.
