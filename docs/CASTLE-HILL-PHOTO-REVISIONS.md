...
**Source-audit correction (2026-09-07, Meta creative pack):** the facility and partnership Youth assets have documented photographic sources. The adult coaching asset is **AI-derived**, not a real photograph: `scripts/prepare_adults_joao_ai_hero.py` builds it from `assets/source-images/adults-joao-coaching-ai-original-2026-07-31.png`. The earlier blanket real-photo assertion was incorrect. Do not use that adult asset in real-photo-only advertising. This documentation correction does not alter the live page; any website replacement is a separate scoped decision. Native export dimensions below describe files, not proof of photographic authenticity.
