...
- **2026-06-11** — **Joao's 3 priorities confirmed** (00-PROFILE): privates, the schools/curriculum system (Line B — ⚠ clarify martial-arts vs academic schools, intake 6.8), and kids/group growth. **First-party class data** (Diego's son enrolled; Diego in adult program): kids ~15–17/class, adults 2–3/class. Plan adjusted (07 §6A): privates pulled forward into landing page v1; adult group = cold-start problem → route adults to privates now, relaunch group as date-bound named cohort later; never market the empty class. Kids growth = referrals + capacity math.
