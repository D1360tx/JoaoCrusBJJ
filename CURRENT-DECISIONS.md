...
- 🟡 **Homeschool BJJ review page (2026-08-11, Diego):** build a separate `noindex,nofollow` review page for the confirmed Dripping Springs Homeschool Program, ages 5–8, Tuesday and Thursday from 10:30–11:15 a.m. Use the approved campaign system, real academy photography, the shared schedule component, claim-safe parent copy, and an honest non-transmitting preview form. Do not promote it to the production manifest or navigation until comparison approval.
