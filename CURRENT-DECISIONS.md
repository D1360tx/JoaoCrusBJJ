...
- ✅ **Meta lead-source decision (2026-08-26, Diego):** keep the current paid-social campaign website-only. Do not add Meta Instant Forms or implement Conversions API for CRM lead-stage optimization at this time. Complete the website Pixel/CAPI, deduplication, attribution, and HighLevel acceptance gates for the current campaign. Test an Instant Form lane and its separate CRM-stage feedback workflow later as a controlled comparison.
